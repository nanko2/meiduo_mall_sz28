...
"""
# from . import prov
# from meiduo_mail.utils import jinja2_env
...
SECRET_KEY = 'xity%cwq##%-6)qzcppt(n)*foa3!ao2vv@#*603e)r8-mq3%#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True #Django默认就开启的测试模式,Django会提供静态文件访问的支持,如果设置主Flase,Django不再提供静态访问
...
# 指定文件存储远程主机域名端口
# MEDIA_URL = 'http://192.168.17.128:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.15.73:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
